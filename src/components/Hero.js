    ...
    <section className="hero">
      <Carousel fade prevLabel="" nextLabel="">
        <Carousel.Item>
          ...
          <Carousel.Caption className="text-lg-start text-center">
        ...
        <Carousel.Item>
          <div className="hero-img-container">
            <img src={slider3} className="hero-img" alt="Third slide" />
          </div>
          <Carousel.Caption className="text-lg-start text-center">
            <h1>Nischidha Imaging Services</h1>
            <h5 className="my-3 w-50 hero-sub">
      ...
      <Container>
        <div className="mobile-hero">
          ...
          <Link to="/about/mission">
            <button className="btn btn-primary hero-btn">Read More</button>
          </Link>
        </div>
      </Container>
    </section>
